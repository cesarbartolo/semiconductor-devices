...
print ('rise time (ps):', risetime*1e12)
...
Bandwidth_GHz=0.35/(risetime)
print ('Bandwidth(GHz):',Bandwidth_GHz/(1e9) )
...
print ('fall time (ps):', falltime*1e12)
...
plt.savefig(path_file +'.png', format='png', dpi=1000)
plt.show()
